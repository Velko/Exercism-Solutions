...
public static class Sieve
{
    ...
    {
        var composites_queue = new PriorityQueue<PrimeComposite, long>();
        ...
        for (;;)
        {
            ...
            if (is_prime)
            {
                ...
                /* While the algorithm itself poses no upper limit for the calculation,
                   ...
                   so stop adding new Composites to list once Math.Sqrt(int.MaxValue)

                   Once past that, the multiplication will overflow and add invalid items,
