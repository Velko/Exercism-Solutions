...
public struct Coord
{
    ...
    public int DistanceSquaredTo(Coord other)
    {
        /* Pythagorean theorem to calculate the length of a side.
           ...
           for squares.
        */
        int length_x = (int)X - (int)other.X;
        int length_y = (int)Y - (int)other.Y;

        return length_x * length_x + length_y * length_y;
    }
}
...
public class ClaimsHandler
{
    ...
    public Plot GetClaimWithLongestSide()
    {
        ...
        foreach (var plot in plots)
        {
            ...
            {
                int sideSquared = side_start.DistanceSquaredTo(side_end);
